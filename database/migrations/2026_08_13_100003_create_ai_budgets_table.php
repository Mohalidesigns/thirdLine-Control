...
return new class extends Migration
{
     ...
     * (R7) — Anthropic prices in USD, so a tenant reporting in naira sees
     * the converted figure through the existing exchange-rate table rather
     * than a rounded number stored twice.
     *
