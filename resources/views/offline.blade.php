...
<head>
    ...
    <style>
        body { font-family: ui-sans-serif, system-ui, sans-serif; background: #0B1F3A; color: #fff;
               display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; }
        .card { text-align: center; padding: 2rem; max-width: 22rem; }
        .badge { width: 56px; height: 56px; border-radius: 14px; background: #C9A227; color: #0B1F3A;
        ...
        button { background: #C9A227; color: #0B1F3A; border: 0; border-radius: 8px;
